...
double BrainConfig::get_teammate_collision_width() {
    return static_cast<rclcpp::Node*>(brain)->get_parameter_or("strategy.cooperation.teammate_collision_width", 0.65);
}

double BrainConfig::get_teammate_emergency_stop_distance() {
    return static_cast<rclcpp::Node*>(brain)->get_parameter_or("strategy.cooperation.teammate_emergency_stop_distance", 0.75);
}

double BrainConfig::get_teammate_yield_speed_limit() {
    return static_cast<rclcpp::Node*>(brain)->get_parameter_or("strategy.cooperation.teammate_yield_speed_limit", 0.25);
}
